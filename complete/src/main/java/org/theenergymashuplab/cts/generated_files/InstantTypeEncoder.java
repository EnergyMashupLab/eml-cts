...
public class InstantTypeEncoder
{
    ...
    public InstantTypeEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public InstantTypeEncoder seconds(final long value)
    {
    ...
    public InstantTypeEncoder nano(final long value)
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final InstantTypeDecoder decoder = new InstantTypeDecoder();
