...
public class IntervalTypeEncoder
{
    ...
    public IntervalTypeEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    private final InstantTypeEncoder dtStart = new InstantTypeEncoder();
     ...
     */
    public InstantTypeEncoder dtStart()
    {
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final IntervalTypeDecoder decoder = new IntervalTypeDecoder();
