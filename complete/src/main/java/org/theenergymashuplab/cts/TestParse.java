...
public class TestParse {
	...
	public static void main(String[] args) {
		...
		System.out.println("zoneIdTemp based on normalized zoneId is " + zoneIdTemp.getId());
		...
		/*
		 * Error - zoneOffset = ZoneOffset.of(zoneId.getId()); System.out.println("ZoneOffset from ZoneId " +
		 * zoneOffset.toString() );
		 */
