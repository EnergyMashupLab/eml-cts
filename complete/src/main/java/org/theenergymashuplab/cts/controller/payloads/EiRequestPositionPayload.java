...
public class EiRequestPositionPayload {
    ...
    public EiRequestPositionPayload(Interval boundingInterval, MarketIdType marketId, ActorIdType positionParty,
            RefIdType requestId, ActorIdType requestor, ResourceDesignator resourceDesignator) {
    ...
    public String toString() {
        return ("EiRequestPosition boundingInterval " + boundingInterval.toString() + " marketId " + marketId.value()
                + " positionParty " + positionParty.value() + " requestId " + requestId.toString() + " requestor "
                + requestor.value() + " resourceDesignator " + resourceDesignator.toString());
    }
