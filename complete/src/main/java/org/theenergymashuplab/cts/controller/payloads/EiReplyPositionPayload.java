...
public class EiReplyPositionPayload {
    ...
    public EiReplyPositionPayload(Interval boundingInterval, ActorIdType positionParty, CtsStreamType positions,
            ActorIdType requestor, EiResponseType response) {
