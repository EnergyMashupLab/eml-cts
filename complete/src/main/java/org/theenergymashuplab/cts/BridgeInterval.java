...
public class BridgeInterval {
	...
	/*
	 * Construct Interval from java.time.Duration and Instant instant should be constructed and passed in after application of
	 * ZonedDateTime.toInstant() elsewhere duration is number of minutes, converted in the constructor
	 */
