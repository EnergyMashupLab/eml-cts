...
public class BridgeInterval {
	...
	private static final DateTimeFormatter INSTANT_INSTRUMENT_FORMATTER = DateTimeFormatter.ofPattern("MMddHHmm")
	...
	/*
	 * Construct Interval from java.time.Duration and Instant instant should be constructed and passed in after
	 * application of ZonedDateTime.toInstant() elsewhere duration is number of minutes, converted in the constructor
	 */
	...
	public String toString() {
		return "\\\"durationInMinutes\\\":" + this.getDurationInMinutes()
				+ ",\\\"dtStart\\\":{\\\"instantString\\\":\\\"" + this.getDtStart().getInstantString() + "\\\"}";
	}
}
