...
public class EiTenderType extends TenderBase {
	...
	/*
	 * TODO Not up to March 2024 spec. This ought to be provided by the market (parity) but parity does not provide its
	 * parity order id at this moment. Thus a new cts-generated id is used in the time being
	 */
	...
	public String toString() {
		return "EiTenderType [tenderId=" + tenderId + ", referencedQuoteId=" + referencedQuoteId + ", marketOrderId="
				...
				+ getExecutionInstructions() + ", marketId=" + getMarketId() + ", priceScale=" + getPriceScale()
				+ ", quantityScale=" + getQuantityScale() + ", resourceDesignator=" + getResourceDesignator()
				+ ", tnderDetail=" + getTenderDetail() + ", warrants=" + getWarrants() + "]";
	}
