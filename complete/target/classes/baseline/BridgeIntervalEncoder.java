...
public class BridgeIntervalEncoder
{
    ...
    public BridgeIntervalEncoder wrap(final MutableDirectBuffer buffer, final int offset)
    {
    ...
    public static int durationInMinutesEncodingOffset()
    {
        return 0;
    }

    public static int durationInMinutesEncodingLength()
    {
        return 4;
    }

    public static long durationInMinutesNullValue()
    {
        return 4294967295L;
    }

    public static long durationInMinutesMinValue()
    {
        return 0L;
    }

    public static long durationInMinutesMaxValue()
    {
        return 1073741824L;
    }
    ...
    public StringBuilder appendTo(final StringBuilder builder)
    {
        ...
        final BridgeIntervalDecoder decoder = new BridgeIntervalDecoder();
